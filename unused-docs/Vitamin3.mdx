...
The Board solutions solves all questions with around 1-3 lines of CSS per selector.
...
tricky to do! We recommend using flexbox for this. The Board solution uses 5 CSS
